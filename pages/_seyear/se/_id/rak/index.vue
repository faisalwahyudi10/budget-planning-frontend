            ...
            <div class="card !gap-y-10 min-h-[200px]">
              <div class="flex items-center justify-between">
                <div class="p-4">
                  ...
                  <div class="text-[36px] font-bold text-dark mt-[6px]">{{ budgetTotal | currency('Rp. ') }}</div>
                </div>
                <div class="py-4 pr-6">
            ...
            <div class="card !gap-y-10 min-h-[200px]">
              <div class="flex items-center justify-between">
                <div class="p-4">
                  ...
                  <div class="text-[36px] font-bold text-dark mt-[6px]">{{ actualTotal | currency('Rp. ') }}</div>
                </div>
                <div class="py-4 pr-6">
                            ...
                            <div class="pb-2">
                                ...
                                <div class="relative overflow-x-auto">
                                    ...
                                    <table class="w-full mt-5 text-sm text-left text-center text-gray-500 dark:text-gray-400">
                                        ...
                                        <tbody>
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" v-for="(cashBudget, index ) in resultQuery">
