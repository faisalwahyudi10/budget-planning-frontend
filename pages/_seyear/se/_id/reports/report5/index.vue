  ...
  <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
    ...
    >
      <div class="flex items-center justify-between gap-4">
        ...
        <div class="text-[32px] font-semibold text-dark">Laporan Program Pertahun</div>
      </div>
    </section>
                                    ...
                                    <div class="py-5 grid grid-cols-2 gap-[20px] text-right">
                                        ...
                                        <div class="flex items-center w-full mb-5">
                                            ...
                                            <div class="relative w-full">
                                                ...
                                                <select v-model="selectedYear2" id="simple-search" class="block w-full p-3 pl-10 text-lg text-gray-900 bg-white border border-gray-100 rounded-lg focus:ring-blue-500 focus:border-blue-500 h-14 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
export default {
    ...
    methods: {
        ...
        openReport() {
            this.$router.push({
                name: 'seyear-se-id-reports-pdf-report5',
                // params: {
