  ...
  <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
    ...
    >
      <div class="flex items-center justify-between gap-4">
        ...
        <div class="text-[32px] font-semibold text-dark dark:text-gray-100">Kegiatan Program {{ programs.name }}</div>
      </div>
    </section>
    ...
    <section class="pt-[50px]">
      ...
      <div class="mb-[30px]">
        ...
        <div class="flex items-center w-full my-5">   
          ...
          <div class="relative w-full">
              ...
              <input type="text" v-model="searchQuery" id="simple-search" class="bg-white dark:bg-slate-800 border border-gray-100 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full h-14 pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required>
          </div>
        </div>
        <div class="text-lg font-medium text-dark dark:text-gray-100">Rencana Anggaran : {{ programs.budget | currency('Rp. ') }}</div>
        <div class="text-lg font-medium text-dark dark:text-gray-100">Total Anggaran Kegiatan : {{ costTotal | currency('Rp. ') }}</div>
        <div class="text-lg font-medium text-dark dark:text-gray-100">Total Realisasi Kegiatan : {{ costTotal2 | currency('Rp. ') }}</div>
      </div>
      ...
      <p v-if="$fetchState.pending">Fetching activities...</p>
        <div class="items-start card !flex-row gap-4" v-else v-for="(activity, index) in resultQuery">
          ...
          <div>
            <div class="mb-2 font-semibold text-dark dark:text-gray-100">
                {{ activity.name }}
            </div>
              ...
              <div class="relative w-auto max-w-6xl mx-auto my-6">
                ...
                <div class="relative flex flex-col w-full bg-white dark:bg-slate-800 border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                  ...
                  <div class="flex items-start justify-between p-5 border-b border-solid rounded-t border-slate-200">
                    ...
                    <button class="float-right p-1 ml-auto text-3xl font-semibold leading-none text-black dark:text-white bg-transparent border-0 outline-none opacity-5 focus:outline-none" v-on:click="detailActivity()">
