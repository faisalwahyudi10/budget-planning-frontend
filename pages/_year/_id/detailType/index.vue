  ...
  <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
    ...
    >
      <div class="flex items-center justify-between gap-4">
        ...
        <div class="text-[32px] font-semibold text-dark dark:text-gray-100">Jenis Belanja</div>
      </div>
    </section>
    ...
    <section class="pt-[50px]">
      ...
      <div class="mb-[30px]">
        ...
        >
          <div>
            <div class="text-xl font-medium text-dark dark:text-gray-100">Jenis</div>
        ...
        <div class="relative overflow-x-auto">
              <table class="w-full text-base text-left text-center text-gray-500 dark:text-gray-400">
                  ...
                  <tbody>
                      <tr class="bg-white dark:bg-slate-800 border-b dark:bg-gray-800 dark:border-gray-700" v-for="(detailType, n ) in detailTypes">
