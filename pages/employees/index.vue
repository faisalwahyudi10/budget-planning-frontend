  ...
  <div class="lg:pr-[70px] py-[50px] lg:ml-[320px] xl:ml-[365px] px-4 lg:pl-0">
    ...
    >
      <div class="flex items-center justify-between gap-4">
        ...
        <div class="text-[32px] font-semibold text-dark dark:text-gray-100">Pegawai</div>
      </div>
    ...
    <section class="pt-[50px]">
      ...
      <div class="mb-[30px]">
        ...
        <div class="flex items-center justify-between gap-6">
          <div class="mt-5">
            <div class="text-xl font-medium text-dark dark:text-gray-100">Pegawai</div>
            <p class="text-grey">Data Pegawai</p>
          </div>
        </div>
      </div>
      ...
      >
        ...
        <div class="items-center card py-6 md:!py-10 md:!px-[38px] !gap-y-0" v-else v-for="employee in resultQuery">
          ...
          ></a>
          <img :src="'http://localhost/'+ employee.photo" width="145" height="145" alt="" class="rounded-full" />
          <div class="mt-6 mb-1 font-semibold text-center text-dark dark:text-gray-100">
            {{ employee.name }}
          </div>
              ...
              <div class="relative w-auto max-w-6xl mx-auto my-6">
                ...
                <div class="relative flex flex-col w-full bg-white dark:bg-slate-800 border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                  ...
                  <div class="flex items-start justify-between p-5 border-b border-solid rounded-t border-slate-200">
                    ...
                    <button class="float-right p-1 ml-auto text-3xl font-semibold leading-none text-black dark:text-white bg-transparent border-0 outline-none opacity-5 focus:outline-none" v-on:click="toggleModal()">
